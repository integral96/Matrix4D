    ...
    try {
        {
            ...
            MATRIX<1, double> A1(shape1D);
            MATRIX<2, double> A2(shape2D);
            MATRIX<3, double> A3(shape3D);
            MATRIX<3, double> B3(shape3D);
            MATRIX<3, double> C3(shape3D);
            MATRIX<3, double> D3(shape3D);
